...
{block name='step_content'}
  <div class="js-address-form">
    ...
    >
      ...
      {if !$use_same_address}
        <h2 class="h4 delivery">{l s='Delivery Address' d='Shop.Theme.Checkout'}</h2>
      {/if}

      {if $use_same_address && !$cart.is_virtual}
        <p>
          {l s='The selected address will be used both as your pick-up address and as your delivery address.' d='Shop.Theme.Checkout'}
        </p>
      {elseif $use_same_address && $cart.is_virtual}
        <p>
          {l s='The selected address will be used as your pick-up address.' d='Shop.Theme.Checkout'}
        </p>
      {/if}
        ...
        {if $use_same_address && !$cart.is_virtual}
          <p>
            <a data-link-action="different-invoice-address" href="{$use_different_address_url}">
              {l s='Pick-up address differs from delivery address' d='Shop.Theme.Checkout'}
            </a>
          </p>
        {/if}
      ...
      {if !$use_same_address}
        ...
        <h2 class="h4 pickup">{l s='Your Pick-Up Address' d='Shop.Theme.Checkout'}</h2>
